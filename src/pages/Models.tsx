...
const ALL_MODELS = [
  {
    ...
    architecture: "CodeBERT (fine-tuned transformer)",
    trainingData: "50k+ open-source repos from GitHub",
    useCase: "Code patterns, anti-patterns, code smells",
    techStack: ["PyTorch", "HuggingFace Transformers", "CodeBERT"],
    metrics: [
      { label: "Benchmark Accuracy", value: "87%", pct: 87 },
      { label: "Avg Inference Time", value: "1.2 s", pct: 88 },
    ],
    description:
      "Fine-tuned CodeBERT detects anti-patterns and stylistic violations with semantic understanding beyond simple pattern matching.",
  ...
  },
  {
    ...
    architecture: "Random Forest + 1D CNN ensemble",
    trainingData: "AST patterns, token sequences, 1 500 synthetic samples",
    useCase: "SQL injection, XSS, hardcoded secrets, path traversal",
    techStack: ["scikit-learn", "PyTorch", "Python"],
    metrics: [
      { label: "RF AUC",       value: "1.000", pct: 100 },
      { label: "CNN AUC",      value: "1.000", pct: 100 },
      { label: "Ensemble AUC", value: "1.000", pct: 100 },
      { label: "Train / Test", value: "1 275 / 225", pct: 85 },
    ],
    description:
      "Ensemble of Random Forest and CNN trained on ASTs and control-flow graphs. Detects OWASP Top 10 vulnerabilities.",
  ...
  },
  {
    ...
    architecture: "Logistic Regression + MLP ensemble",
    trainingData: "17 static + 5 git features, 1 500 labeled samples",
    useCase: "Flags high-risk functions before they ship",
    techStack: ["scikit-learn", "PyTorch", "Python"],
    metrics: [
      { label: "LR Test AUC",  value: "1.000", pct: 100 },
      { label: "LR Test Acc",  value: "1.000", pct: 100 },
      { label: "MLP Best Loss","value": "0.001", pct: 99 },
      { label: "Input dim",    value: "22 feat", pct: 80 },
    ],
    description:
      "LR baseline for interpretability + MLP for accuracy. Trained on 22 features covering static metrics and commit history signals.",
